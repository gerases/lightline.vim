" =============================================================================
" Filename: autoload/lightline/colorscheme/solarized_darker.vim
" Author: itchyny
" License: MIT License
...
let s:p.normal.left = [ [ s:base3, s:base01 ], [ s:base3, s:blue ], [ s:base3, s:base01 ] ]
let s:p.normal.right = [ [ s:base02, s:base0 ], [ s:base1, s:base01 ] ]
let s:p.inactive.right = [ [ s:base02, s:base01 ], [ s:base00, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base02 ], [ s:base00, s:base02 ] ]
let s:p.insert.left = [ [ s:base3, s:base01 ], [ s:base3, s:base01 ] ]
let s:p.replace.left = [ [ s:base3, s:red ], [ s:base3, s:base01 ] ]
let s:p.visual.left = [ [ s:base3, s:base01 ], [ s:base3, s:base01 ] ]
...
let g:lightline#colorscheme#solarized_darker#palette = lightline#colorscheme#flatten(s:p)
